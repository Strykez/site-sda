$(document).ready(function() {
    ...
    $('.save-btn').click(function() {
        ...
        // Check if data is forwarde correctly (It is)
        console.log("Sending data: " + name + ", " + email + ", " + role);
        $.post("misc_scripts/save_admin.php", { name: name, email: email, role: role }, function(data) {
        console.log("Received data: " + JSON.stringify(data));
        });
    
        // execute PHP script to update data in db
